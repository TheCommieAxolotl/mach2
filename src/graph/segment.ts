 ...
 */
export const segment = (ctx: CanvasRenderingContext2D, points: Point[], color: Color, weight = 1) => {
    if (!points.length) {
        return;
    }
 ...
 */
export const curveSegment = (ctx: CanvasRenderingContext2D, points: Point[], color: Color, weight = 1) => {
    if (!points.length) {
        return;
    }
